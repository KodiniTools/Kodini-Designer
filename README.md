...
| `server/codeupdate.mjs`                      | Website-Code vor der Vorschau per fast-forward holen (gespeicherte Entwürfe der Content-Dateien bleiben erhalten), `npm ci` bei fehlendem `node_modules`; Selbst-Neustart unter systemd                                                                                                                                                          |
